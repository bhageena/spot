...
exports.isQueryParamArrayStrategy = exports.isHttpMethod = exports.getJsDoc = exports.getPropertyName = exports.getPropValueAsObjectOrThrow = exports.getPropValueAsArrayOrThrow = exports.getPropValueAsNumberOrThrow = exports.getPropValueAsStringOrThrow = exports.getObjLiteralPropOrThrow = exports.getObjLiteralProp = exports.getDecoratorConfigOrThrow = exports.getParameterTypeAsTypeLiteralOrThrow = exports.getParamWithDecorator = exports.getMethodWithDecorator = exports.getPropertyWithDecorator = exports.getClassWithDecoratorOrThrow = exports.getSelfAndLocalDependencies = void 0;
 ...
 */
function getParameterTypeAsTypeLiteralOrThrow(parameter) {
    const typeNode = parameter.getTypeNodeOrThrow();
    if (!ts_morph_1.TypeGuards.isTypeLiteralNode(typeNode)) {
        throw new Error("expected parameter value to be an type literal object");
    }
    return typeNode;
}
exports.getParameterTypeAsTypeLiteralOrThrow = getParameterTypeAsTypeLiteralOrThrow;
// DECORATOR HELPERS
/**
