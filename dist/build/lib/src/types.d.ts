...
export declare type Type = NullType | BooleanType | BooleanLiteralType | StringType | StringLiteralType | FloatType | DoubleType | FloatLiteralType | Int32Type | Int64Type | IntLiteralType | DateType | DateTimeType | ObjectType | ArrayType | UnionType | ReferenceType;
/**
 * A concrete type is any type that is not a union of types or reference to a type.
 */
export declare type ConcreteType = Exclude<Type, UnionType | ReferenceType>;
/**
 * A concrete type is any type that is not a
 */
export declare type PrimitiveType = Exclude<Type, ObjectType | ArrayType | UnionType | ReferenceType>;
