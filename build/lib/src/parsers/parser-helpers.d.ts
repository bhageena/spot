import { ArrayLiteralExpression, ClassDeclaration, Decorator, JSDoc, JSDocableNode, MethodDeclaration, NumericLiteral, ObjectLiteralExpression, ParameterDeclaration, PropertyAssignment, PropertyDeclaration, PropertySignature, SourceFile, StringLiteral, TypeLiteralNode } from "ts-morph";
 ...
 */
export declare function getParameterTypeAsTypeLiteralOrThrow(parameter: ParameterDeclaration): TypeLiteralNode;
/**
